package util.PlanarityTester.java;
...
//        Graph<String> graph = readGraphFromFile( "/Volumes/Macintosh HD/Volumes/Macintosh HD/Users/FireAwayH/Github/Dependency_Network/src/main/java/util/PlanarityTester/input/p6" );
        Graph<String> graph = new Graph<>();
        graph.addEdge("Abf", "Aht");
        graph.addEdge("Abf", "Aal");
        Graph<String> cycle = (new GraphTraverser<>(graph)).findCycle();
     ...
     */
    public static Graph<Integer> readGraphFromFile2( String fileName ) {
     ...
     * @return          The newly constructed graph.
     */
    public static Graph<String> readGraphFromFile( String fileName ) {
        Graph<String> graph = new Graph<>();
        Scanner in;
        try {
            in = new Scanner( new BufferedInputStream( new FileInputStream( fileName )));
