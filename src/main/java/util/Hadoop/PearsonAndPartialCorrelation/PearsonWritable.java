...
public class PearsonWritable implements Writable {
	...
	private PearsonWritable XY;
	private PearsonWritable XZ;
	private PearsonWritable YZ;
	/**
	 * Constructor.
	 */
	 ...
	 *            Total data points.
	 */
	public PearsonWritable(double x, double y, double xx, double yy, double xy, double n) {
		this.x = x;
		this.y = y;
		this.xx = xx;
		this.yy = yy;
	...
	public double getCorrelation() {
		...
		double numerator = x / n; // EX
		numerator = numerator * y; // EX * EY
		numerator = xy - numerator; // EXY - EX * EY

		double denom1 = Math.pow(x, 2.0d) / n; // EX^2
		denom1 = xx - denom1; // E(X^2) - EX^2

		double denom2 = Math.pow(y, 2.0d) / n; // EY^2
		denom2 = yy - denom2; // E(Y^2) - EY^2
