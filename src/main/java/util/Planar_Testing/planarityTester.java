package util.Planar_Testing;

public class planarityTester {

    /**
     * Code From "A Java Library of Graph Algorithms and Optimization, Hang T. Lau p152-171 "
     * @param n int; entry: the number of nodes of the undirected graph, labeled from 1 to n.
     * @param m int; entry: the number of edges in the graph.
...
//        int n = 7;
//        int m = 10;
//        int nodei[] = {1, 5, 2, 7, 1, 3, 5, 7, 4, 1, 1};
//        int nodej[] = {5, 2, 4, 4, 7, 5, 6, 3, 6, 4, 2};

        int n = 2;
        int m = 1;
        int nodei[] = {0, 1};
        int nodej[] = {0, 2};
        if (planarityTesting(n, m, nodei, nodej))
